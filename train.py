...
if __name__ == "__main__":
    ...
    # DATA_PATH = "data/amass_train_scaled.pkl"
    CHECKPOINT_DIR = "checkpoints"
    BEST_MODEL_PATH = os.path.join(CHECKPOINT_DIR, "ae_best_model.pth") # Save best model here
    os.makedirs(CHECKPOINT_DIR, exist_ok=True)
    writer = SummaryWriter('runs/ae_experiment_split')
